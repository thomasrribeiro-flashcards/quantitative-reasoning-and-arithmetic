...
| **Complete deck** | **177 basic, 45 problems, 0 clozes, 31 figures, including the approved pilot and the refined chapter-9 design.** | **187 basic, 45 problems, 0 clozes, 31 figures; 232 cards total (chapter 9 regenerated fresh in the 2026-07-23 isolated run).** | **The chapter-4, chapter-6, chapter-7, and chapter-9 refinements are explained above. No planned target or figure role is missing, and no weak card was added to force a distribution.** |
