...
![Part–whole diagram: two upper boxes labeled part hold the numerals 6 and 3; a wider lower box labeled whole holds a question mark](../figures/02_addition_and_subtraction/part_whole_diagram.svg)
...
![An open number line with a dot on the mark labeled 34; a curved arrow labeled plus 20 jumps right to the mark labeled 54, and a shorter curved arrow labeled plus 3 jumps right to a mark labeled with a question mark](../figures/02_addition_and_subtraction/open_number_line.svg)
...
![Twelve loose counters on one side and, on the other side, one outlined loop holding ten counters together with two loose counters; a double-headed arrow between the two sides is labeled same quantity](../figures/02_addition_and_subtraction/regrouping_exchange.svg)
